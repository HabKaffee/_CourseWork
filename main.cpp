...
int main() {
    ...
    auto finish = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> duration = finish - start;
    double standart = duration.count();
    start = std::chrono::high_resolution_clock::now();
    VLex(n);
    finish = std::chrono::high_resolution_clock::now();
    duration = finish - start;
    ...
    std::cout << "Time elapsed without cycles: " << std::setprecision(10) << arr[2]/m << std::endl;
    std::cout << "Time elapsed standard: " << std::setprecision(10) << arr[1]/m << std::endl;
    std::cout << "Time elapsed lexic: " << std::setprecision(10) << arr[0]/m << std::endl; */
    return 0;
}
